> **Note:** this repo is a fork of the original @linuxserver container 
> docker-nzbget, which was deprecated following the archiving of 
> the original @nzbget project.
> 
> I have updated the image to refer to the new @nzbget-ng fork
> and automate builds using Github Actions.
>
> The content below has NOT been update and currently contain old 
> references... it's on my to-do list. :-)
> - Brad, 2023.02.18
